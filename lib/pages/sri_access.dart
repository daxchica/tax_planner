...
class SriAccessPage extends StatefulWidget with NavigationState {
  const SriAccessPage({Key? key}) : super(key: key);

  @override
  _SriAccessPageState createState() => _SriAccessPageState();
}

class _SriAccessPageState extends State<SriAccessPage> {
  @override
  void initState() {
    super.initState();
  }
...
//         return WebView(
//           initialUrl: 'https://www.sri.gob.ec',
